        ...
        <div class="container">
            <div class="card-body">
                <form method="POST" action="{{ route('student.update', $student->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        <label for="type_id" class="col-md-4 col-form-label text-md-end">Форма обучение</label>
                    ...
                    <div class="row mb-3">
                        <label for="type_id" class="col-md-4 col-form-label text-md-end">Пол</label>

                        <div class="col-md-6">
                            <select class="form-select" aria-label="Default select example" id="gender" name="gender">
                                <option value="male"
                                    {{$student->gender == 'male' ? 'selected' : ''}}> Мужчина
                                </option>
                                <option value="woman"
                                    {{$student->gender == 'woman' ? 'selected' : ''}}> Женщина
                                </option>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <input id="address" type="text" class="form-control" name="address" value="{{ $student->user->address }}">
                            @error('address')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <input id="age" type="text" class="form-control" name="age" value="{{ $student->user->age }}">
                            @error('age')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <textarea id="text" type="text" class="form-control" name="content">{{ $student->user->content }}</textarea>
                            @error('content')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-sm-6">
                            <img class="img-fluid mb-3" src="{{asset($student->user->image)}}"  alt="image" style="width:200px;height:200px;">
                        </div>
