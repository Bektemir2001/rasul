...
class ChangeQuestionRequest extends FormRequest
{
    /**
    ...
    public function messages(){
        Session::flash('ErrorWithQuestion'.$this->id,'ErrorWithQuestion'.$this->id);
        return [
            ...
            'score.integer' => 'пожалуйста, напишите число'
        ];
    }
}
